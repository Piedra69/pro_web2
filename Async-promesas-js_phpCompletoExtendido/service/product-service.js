// const API_BASE_URL = 'http://localhost/api1/Conexion_productos.php'; // ANTES DEL BUSCADOR
const API_BASE_URL = 'http://localhost/api1/conexion_productos_buscador.php';
